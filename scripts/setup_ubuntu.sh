...
echo "   - qwen2.5-32b-instruct-q4_k_m.gguf (primary assistant model)"
echo "   - qwen2.5-14b-instruct-q4_k_m.gguf (lighter fallback model)"
echo "   Optional: qwen2.5-coder-32b-instruct-q4_k_m.gguf (specialist code hot-swap)"
echo "   Quick install: bash $REPO_ROOT/scripts/install_qwen25_32b.sh"
echo ""
