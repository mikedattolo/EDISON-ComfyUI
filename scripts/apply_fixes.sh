...
echo "=================================================="
echo ""
echo "1. MULTI-GPU SUPPORT (GPU order on this host: 5060ti, 4060ti, 3090)"
echo "   - Added tensor_split=[0.25, 0.25, 0.50] to both models"
echo "   - 5060ti gets 25% of model, 4060ti gets 25%, 3090 gets 50%"
